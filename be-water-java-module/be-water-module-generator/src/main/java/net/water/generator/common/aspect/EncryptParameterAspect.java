package net.water.generator.common.aspect;

import lombok.extern.slf4j.Slf4j;
import net.water.generator.common.annotation.EncryptParameter;
import net.water.generator.common.page.PageResult;
import net.water.generator.common.utils.EncryptUtils;
...
public class EncryptParameterAspect {
     ...
     * @throws Throwable
     */
    @Around("execution(* net.water.generator.controller.DataSourceController.*(..))")
